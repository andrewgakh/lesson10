...
class Cards():
    def __init__(self):
        ...
        self.koloda_play = [['8', 'C', 8], ['Q', 'C', 12], ['A', 'P', 14], ['9', 'P', 9],
                             ['10', 'C', 10], ['A', 'C', 14], ['10', 'B', 10], ['6', 'C', 6], ['9', 'C', 9], ['Q', 'T', 12],
                             ['Q', 'B', 12], ['10', 'P', 10], ['K', 'C', 13], ['6', 'T', 6], ['6', 'P', 6], ['J', 'P', 11],
                            ['10', 'T', 10], ['A', 'B', 14], ['7', 'T', 7], ['7', 'C', 7], ['K', 'T', 13], ['9', 'B', 9], ['6', 'B', 6]]      # Игральная колода карт
        self.cards_player2 = [['8', 'B', 8], ['10', 'B', 10], ['K', 'T', 13], ['A', 'P', 14], ['6', 'T', 6]]                                 # Карты игрока 1
        self.cards_player1 = [['Q', 'B', 12], ['10', 'C', 10], ['J', 'B', 11], ['6', 'B', 6], ['7', 'T', 7], ['K', 'B', 13]]                   # Карты игрока 2
        self.kozyr = ['Q', 'P', 12]                                 # Козырная карта
        self.pole_plr_2 = ['9', 'C', 9]                             # Ход игрока 1
...
if __name__ == '__main__':
    ...
    # Тестируем ф-цию otbil_plr_2. Карта Игрока 1 бита наименьшей козырной карты.
    card_game.win_plr_2 = 0
    card_game.win_plr_1 = 0
    card_game.otbil_plr_1()
    assert card_game.win_plr_1 == 1
