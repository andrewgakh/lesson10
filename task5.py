...
class Cards():
    def __init__(self):
        ...
        self.koloda_play = [['8', 'C', 8], ['Q', 'C', 12],  ['A', 'P', 14], ['9', 'P', 9],
                            ...
                            ['10', 'T', 10], ['A', 'B', 14], ['7', 'C', 7], ['K', 'T', 13], ['9', 'B', 9], ['6', 'B', 6]]      # Игральная колода карт
        self.cards_player1 = [['8', 'B', 8], ['10', 'B', 10], ['K', 'T', 13], ['A', 'P', 14], ['6', 'T', 6]]                                 # Карты игрока 1
        self.cards_player2 = [['Q', 'B', 12], ['7', 'C', 7], ['J', 'B', 11], ['6', 'B', 6], ['7', 'T', 7], ['K', 'B', 13]]                  # Карты игрока 2
...
if __name__ == '__main__':
    ...
    # Тестируем ф-цию otbil_plr_2. Карта Игрока 1 не бита. Забтраем карту.
    card_game.win_plr_2 = 0
    card_game.win_plr_1 = 0
    card_game.otbil_plr_2()
    assert card_game.win_plr_2 == 0
